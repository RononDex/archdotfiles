...
sudo pacman -Sy lightdm-webkit-theme-litarvan feh lxterminal lxappearance compton alsa pulseaudio pulseaudio-jack pulseaudio-bluetooth pulseaudio-alsa pavucontrol arc-gtk-theme arc-icon-theme nautilus --noconfirm --needed
